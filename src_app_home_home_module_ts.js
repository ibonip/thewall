...
/***/ 63234:
/*!****************************************************************!*\
  !*** ./src/app/componentes/swiperkuai/swiperkuai.component.ts ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SwiperkuaiComponent": () => (/* binding */ SwiperkuaiComponent)
/* harmony export */ });
...
/* harmony import */ var _swiperkuai_component_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./swiperkuai.component.html?ngResource */ 54364);
/* harmony import */ var _swiperkuai_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./swiperkuai.component.scss?ngResource */ 1189);
...
swiper__WEBPACK_IMPORTED_MODULE_3__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_3__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_3__.Keyboard, swiper__WEBPACK_IMPORTED_MODULE_3__.Manipulation]);
let SwiperkuaiComponent = class SwiperkuaiComponent {
  constructor(loadingCtrl) {
    this.loadingCtrl = loadingCtrl;
    this.eventoCambiaSlide = new _angular_core__WEBPACK_IMPORTED_MODULE_4__.EventEmitter();
    this.eventoCambiando = new _angular_core__WEBPACK_IMPORTED_MODULE_4__.EventEmitter();
  }

  ngOnInit() {
    this.eventsSubscription = this.eventoCarga.subscribe(datos => this.cargaElementos(datos));
    this.contractAddress = localStorage.getItem("contratoTheWall");
  }

  cargaElementos(datos) {
    var _this = this;
    ...
    return (0,C_Users_Administrathor_Desktop_TheWall_desarrollo_thewall_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      // antes vaciamos todos los slides del anterior resultado de busquedas 
      _this.newSwiper.swiperRef.removeAllSlides();

      let load = yield _this.showLoading();
      let tokenid;
      let name;
      let owner;
      let tokenuri;
      ...
      for (let x = 0; x < datos.length; x += 1) {
        ...
        openseaLink = openseaLink + _this.contractAddress + "/";
        openseaLink = openseaLink + tokenid;
        plantillaHTML = "<div class='swiper-slide'><div id='capaMaestraNFT'><div class='tokenid'>TOKEN #";
        plantillaHTML += tokenid + "</div><div id='tokenid' style='display:none'>" + tokenid + "</div>";
        plantillaHTML += "<div class='nombreNFT'>" + name + "</div>";
        plantillaHTML += "<div id='outerCanvasNFT'><div id='ficha'><div class='divficha'><div class='divOwner'><ion-icon name='person-outline' class='iconoOwner'></ion-icon><div id='addressOwner'>" + owner + "</div></div><div class='divOpensea'><img src='/assets/graficos/opensea.png' id='logoOpensea'><a href=" + openseaLink + "><span class='spanLink'>Comercia con <u><b>" + name + "</b></u> en Opensea</span></a></div></div></div><div class='canvasNFT'>"; // generamos el nft con la info de los pixels : tamaño, colores, y pixels.

        nftpixelsHTML += "<div class='filaPixels'>";

        for (let p = 0; p < pixels.length; p += 1) {
          if (p != 0 && p % size[0] == 0) // cambio fila  
            {
              nftpixelsHTML += "</div>";
              nftpixelsHTML += "<div class='filaPixels'>";
            }

          nftpixelsHTML += "<div class='pixel' style='background-color:" + colors[pixels[p]] + "'><img src='/assets/graficos/pixelAux.png' class='pixelAux'></div>";
        }

        plantillaHTML += nftpixelsHTML;
        plantillaHTML += "</div></div>";
        plantillaHTML += "</div></div>";

        _this.newSwiper.swiperRef.appendSlide(plantillaHTML);
      }

      _this.newSwiper.swiperRef.slideTo(0);

      _this.newSwiper.swiperRef.update();
  ...
  cambiaSlide() {
    let tokenID = document.querySelector(".swiper-slide-active #tokenid").innerHTML;
    let addressOwner = document.querySelector(".swiper-slide-active #addressOwner").innerHTML;
    this.eventoCambiaSlide.emit({
      tokenid: tokenID
    });
  }
...
SwiperkuaiComponent.ctorParameters = () => [{
  type: _ionic_angular__WEBPACK_IMPORTED_MODULE_5__.LoadingController
}];

SwiperkuaiComponent.propDecorators = {
  newSwiper: [{
...
SwiperkuaiComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Component)({
  selector: 'app-swiperkuai',
  template: _swiperkuai_component_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_4__.ViewEncapsulation.None,
  styles: [_swiperkuai_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__]
})], SwiperkuaiComponent);
...
/* harmony import */ var _componentes_swiperkuai_swiperkuai_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../componentes/swiperkuai/swiperkuai.component */ 63234);
...
HomePageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        ...
        declarations: [_home_page__WEBPACK_IMPORTED_MODULE_0__.HomePage, _componentes_swiperkuai_swiperkuai_component__WEBPACK_IMPORTED_MODULE_2__.SwiperkuaiComponent]
    })
], HomePageModule);
...
/* harmony import */ var _services_ionic_toast_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/ionic-toast.service */ 6086);
/* harmony import */ var _services_ion_alert_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/ion-alert.service */ 10469);
...
/* harmony import */ var _componentes_modaldonacion_modaldonacion_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../componentes/modaldonacion/modaldonacion.component */ 12350);
/* harmony import */ var _componentes_modalsms_modalsms_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../componentes/modalsms/modalsms.component */ 54304);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! rxjs */ 92218);
/* harmony import */ var web3__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! web3 */ 30143);
...
let HomePage = class HomePage {
  constructor(cd, modalCtrl, document, ionicToastService, ionicAlertService, router) {
    this.cd = cd;
    this.modalCtrl = modalCtrl;
    this.document = document;
    this.ionicToastService = ionicToastService;
    this.ionicAlertService = ionicAlertService;
    this.router = router;
    this.filtroNombre = [];
    this.resultadosFiltro = [...this.filtroNombre];
    this.visibleFiltro = false;
    this.GoerliChainId = '0x5';
    this.arrayNFT = [];
    this.arrayNFTFiltrado = [...this.arrayNFT];
    this.arrayNFTExtra = [];
    this.arraySMS = [];
    this.wallet = {
      address: '',
    ...
    this.TokenSMS = 0;
    this.BotonSMS = false;
    this.eventObservableNFTLoaded$ = new rxjs__WEBPACK_IMPORTED_MODULE_9__.Subject();
    this.window = document.defaultView;
    sessionStorage.setItem('address', ''); //variable global de sesion para mantener wallet

    sessionStorage.setItem('chainid', this.GoerliChainId);
    localStorage.setItem('contratoTheWall', "0x9D9333d1fED5e4dB78552c687Bf899044122c105");
    this.contractAddress = localStorage.getItem("contratoTheWall");
    this.web3 = new (web3__WEBPACK_IMPORTED_MODULE_8___default())();
  ...
  ngOnInit() {
    ...
    this.ionicAlertService.eventoBotonRed.subscribe(counter => {
      this.cambiaRed();
    });
    this.ionicAlertService.eventoBotonRedCancelar.subscribe(counter => {
  ...
  cargaNFTs() {
    ...
    return (0,C_Users_Administrathor_Desktop_TheWall_desarrollo_thewall_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      let check = 0;
      _this.arrayNFT = yield _this.contract.methods.GetTokenPixels().call().catch(err => {
        _this.ionicAlertService.showAlert("Error de Conexión", "No ha podido conectarse al Smart Contract");

        check = 1;
      });
      if (check == 1) return;
      _this.arrayNFTExtra = yield _this.contract.methods.GetTokenExtra().call().catch(err => {
        _this.ionicAlertService.showAlert("Error de Conexión", "No ha podido conectarse al Smart Contract");
      ...
      _this.eventObservableNFTLoaded$.next(_this.arrayNFT);

      _this.cargaFiltro(_this.arrayNFT);
    })();
  }

  cargaFiltro(datos) {
    for (let x = 0; x < datos.length; x += 1) {
      this.filtroNombre.push(datos[x][1]);
    }
  }
  ...
  loginMetamask() {
    ...
    return (0,C_Users_Administrathor_Desktop_TheWall_desarrollo_thewall_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!_this2.provider) {
        return _this2.ionicAlertService.showAlert("¡ Atención !", "Metamask no está instalado");
      }

      try {
        const accounts = yield _this2.provider.request({
          method: 'eth_requestAccounts'
        });

        _this2.compruebaRed();

        _this2.wallet.address = accounts[0];
        sessionStorage.setItem('address', _this2.wallet.address);

        _this2.getBalance(_this2.wallet.address);
      } catch (error) {
        if (error.code === 4001) {
          _this2.ionicAlertService.showAlert("¡OPS!", "Acceso a Metamask cancelado");
        }
      }
    })();
  }
  ...
  getBalance(address) {
    ...
    return (0,C_Users_Administrathor_Desktop_TheWall_desarrollo_thewall_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this3.wallet.address = address;
      _this3.wallet.balance = yield _this3.web3.eth.getBalance(address).then(result => {
        return _this3.web3.utils.fromWei(result, 'ether');
      });
    })();
  }
  ...
  compruebaRed() {
    ...
    return (0,C_Users_Administrathor_Desktop_TheWall_desarrollo_thewall_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const chainId = yield _this4.provider.request({
        method: 'eth_chainId'
      });

      if (chainId !== _this4.chainID) {
        _this4.ionicAlertService.showAlertRedMetamask("¡ No estás conectado a la red Goerli !");
      }
    })();
  }
  ...
  cambiaRed() {
    ...
    return (0,C_Users_Administrathor_Desktop_TheWall_desarrollo_thewall_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        ...
        _this5.ionicAlertService.showAlert("¡ OK !", "Red Goerli configurada correctamente.");
      } catch (switchError) {
        if (switchError.code === 4902) {
          _this5.ionicAlertService.showAlert("¡ ERROR !", "No tienes la red Goerli configurada en Metamask");
        }

        _this5.ionicAlertService.showAlert("¡ ERROR !", "Imposible cambiar de red");
      }
    })();
  }
  ...
  iraMintear() {
    if (!this.wallet.address) this.ionicAlertService.showAlert("¡OPS!", "Por favor conecta primero tu Wallet a TheWall");else this.router.navigate(['/mintear']);
  }

  filtra(event) {
    const textoB = event.target.value.toLowerCase();

    if (textoB && textoB != '') {
      this.visibleFiltro = true;
      this.resultadosFiltro = this.filtroNombre.filter(d => d.toLowerCase().indexOf(textoB) > -1);
      if (this.resultadosFiltro.length < 1) this.visibleFiltro = false;
    } else this.visibleFiltro = false;
  }
  ...
  busca(event) {
    ...
    let cumple;
    const textoB = event.target.value.toLowerCase();
    this.arrayNFTFiltrado = [];

    for (let x = 0; x < this.arrayNFT.length; x += 1) {
      name = this.arrayNFT[x][1];
      cumple = name.toLowerCase().indexOf(textoB);
      if (cumple > -1) //indeox devuelve un valor mayor de -1 si no encuentra nada y un valor X de la posición del caracter en caso afirmativo
        this.arrayNFTFiltrado.push(this.arrayNFT[x]);
    }

    event.target.value = "";
    this.eventObservableNFTLoaded$.next(this.arrayNFTFiltrado);
    this.visibleFiltro = false;
  }
  ...
  MyNFT() {
    ...
    for (let x = 0; x < this.arrayNFT.length; x += 1) {
      addressaux = this.arrayNFT[x][2];
      cumple = addressaux.toLowerCase().indexOf(address);
    ...
    if (check == 0) this.ionicAlertService.showAlert("¡ OPS !", "No posees ningun NFT de esta colección");else {
      this.eventObservableNFTLoaded$.next(this.arrayNFTFiltrado);
      this.visibleFiltro = false;
    }
  }
  ...
  cambiaSlide(event) {
    this.TokenActivo = event.tokenid;
    this.datosNFTExtra();
    var id = document.getElementById("capaInFooter");
    id.style.opacity = "1";
  }
  ...
  meGusta() {
    ...
    return (0,C_Users_Administrathor_Desktop_TheWall_desarrollo_thewall_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!_this7.wallet.address) return _this7.ionicAlertService.showAlert("¡OPS!", "Por favor conecta primero tu Wallet a TheWall");
      const transactionParameters = {
        nonce: '0x00',
        to: _this7.contractAddress,
        from: _this7.wallet.address,
        value: '0',
        data: _this7.contract.methods.like(_this7.TokenActivo).encodeABI(),
        chainId: _this7.chainID
      };
      const txHash = yield _this7.provider.request({
        method: 'eth_sendTransaction',
        params: [transactionParameters]
      }).then(result => {
        _this7.ionicAlertService.showAlert("MetaMask está procesando la solicitud", "Cuando haya terminado recibirás una confirmacíon en Metamask");
      }).catch(err => {
        if (err.code == 4001) _this7.ionicAlertService.showAlert("MetaMask", "La transacción ha sido cancelada");
      });
    })();
  }
  ...
  compruebaAddress() {
    ...
    if (this.arrayNFT[this.TokenActivo - 1][2].toLowerCase() == this.wallet.address) {
      this.ionicAlertService.showAlert("¡OPS!", "No puedes donarte a ti mismo ;)");
      check = false;
    }
  ...
  patrocinio() {
    ...
    return (0,C_Users_Administrathor_Desktop_TheWall_desarrollo_thewall_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!_this8.wallet.address) return _this8.ionicAlertService.showAlert("¡OPS!", "Por favor conecta primero tu Wallet a TheWall");
      const modal = yield _this8.modalCtrl.create({
        component: _componentes_modaldonacion_modaldonacion_component__WEBPACK_IMPORTED_MODULE_6__.ModaldonacionComponent,
        componentProps: {
          tokenID: _this8.TokenActivo,
          saldo: _this8.wallet.balance
        }
      });

      let comprueba = _this8.compruebaAddress();

      if (!comprueba) return;
      yield modal.present();
      const {
        data
      } = yield modal.onDidDismiss(); // hasta que no se acepta o descarta...

      if (data.orden == "confirmar") {
        let importeWei = _this8.web3.utils.toWei(data.importe, 'ether');

        let importeWeiHex = _this8.web3.utils.toHex(importeWei); // Metamask trabaja en HEX


        const transactionParameters = {
          nonce: '0x00',
          to: _this8.contractAddress,
          from: _this8.wallet.address,
          value: importeWeiHex,
          data: _this8.contract.methods.donar(_this8.TokenActivo, data.texto).encodeABI(),
          chainId: _this8.chainID
        };
        const txHash = yield _this8.provider.request({
          method: 'eth_sendTransaction',
          params: [transactionParameters]
        }).then(result => {
          _this8.ionicAlertService.showAlert("MetaMask está procesando la solicitud", "Cuando haya terminado recibirás una confirmacíon en Metamask");
        }).catch(err => {
          if (err.code == 4001) _this8.ionicAlertService.showAlert("MetaMask", "La transacción ha sido cancelada");
        });
      }
    })();
  }
  ...
  tokenMensajes() {
    ...
    return (0,C_Users_Administrathor_Desktop_TheWall_desarrollo_thewall_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      let check = 0;
      _this9.arraySMS = yield _this9.contract.methods.GetTokenSMS(_this9.TokenActivo).call().catch(err => {
        _this9.ionicAlertService.showAlert("Error de Conexión", "No ha podido conectarse al Smart Contract");

        check = 1;
      });
      if (check == 1) return;
      const modal = yield _this9.modalCtrl.create({
        component: _componentes_modalsms_modalsms_component__WEBPACK_IMPORTED_MODULE_7__.ModalsmsComponent,
        componentProps: {
          tokenArraySMS: _this9.arraySMS,
          tokenID: _this9.TokenActivo
        }
      });
      yield modal.present();
      const {
  ...
  datosNFTExtra() {
    let wei = this.arrayNFTExtra[this.TokenActivo - 1][2];
    this.TokenBalance = this.web3.utils.fromWei(wei, 'ether');
    this.TokenLikes = this.arrayNFTExtra[this.TokenActivo - 1][1];
    this.TokenSMS = this.arrayNFTExtra[this.TokenActivo - 1][2];
    if (this.TokenSMS != "0") this.BotonSMS = true;else this.BotonSMS = false;
    this.cd.detectChanges();
  }

  showMyToast(mensaje) {
    this.ionicToastService.showToast(mensaje);
  }

  showMyToastMy(mensaje) {
    this.ionicToastService.showToastMy(mensaje);
  }
...
HomePage.ctorParameters = () => [{
  ...
  type: _services_ionic_toast_service__WEBPACK_IMPORTED_MODULE_3__.IonicToastService
}, {
  type: _services_ion_alert_service__WEBPACK_IMPORTED_MODULE_4__.IonAlertService
}, {
  type: _angular_router__WEBPACK_IMPORTED_MODULE_13__.Router
}];

HomePage = (0,tslib__WEBPACK_IMPORTED_MODULE_14__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
  selector: 'app-home',
...
/***/ 1189:
/*!*****************************************************************************!*\
  !*** ./src/app/componentes/swiperkuai/swiperkuai.component.scss?ngResource ***!
  \*****************************************************************************/
/***/ ((module) => {

module.exports = ".swiper-slide-active #outerCanvasNFT {\n  background-color: #19422d;\n}\n\n.swiper-slide-active #capaMaestraNFT {\n  background-color: rgb(241, 219, 222);\n}\n\n#capaMaestraNFT {\n  background-color: #b8c0bc;\n  width: 100%;\n  height: 100%;\n  transition: all 0.5s ease-out;\n}\n\n#ficha {\n  background-color: #121212;\n  color: rgb(241, 219, 222);\n  padding-top: 10px;\n  padding-left: 14px;\n  padding-right: 14px;\n  width: 100%;\n  min-height: 20%;\n  visibility: hidden;\n  position: absolute;\n  top: 0px;\n  left: 0px;\n  display: flex;\n  flex-direction: column;\n  transition: all 0ms 0ms;\n  overflow: hidden;\n}\n\n#outerCanvasNFT:hover #ficha {\n  visibility: visible;\n  transition: all 300ms 1200ms;\n}\n\n.divficha {\n  padding: 1px;\n}\n\n#logoOpensea {\n  width: 33px;\n  height: 33px;\n  margin-right: 10px;\n}\n\n.spanLink {\n  color: rgb(241, 219, 222);\n}\n\n.divOpensea {\n  margin-top: 5px;\n  text-align: left;\n  display: flex;\n  align-items: center;\n  font-size: 0.9rem;\n}\n\n.divOwner {\n  text-align: left;\n  display: flex;\n  align-items: center;\n  font-size: 0.7rem;\n}\n\n.iconoOwner {\n  font-size: 1.6rem;\n  margin-right: 15px;\n  margin-left: 3px;\n}\n\n#outerCanvasNFT {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  background-color: #143021;\n  width: 100%;\n  height: 80%;\n  cursor: pointer;\n  transition: all 0.5s ease-out;\n}\n\n.canvasNFT {\n  cursor: crosshair;\n  display: flex;\n  flex-direction: column;\n  background-color: rgb(255, 0, 0);\n  width: 62%;\n  border: 8px solid gainsboro;\n  border-radius: 8px;\n  transition: all 0.15s ease-out; /* W3C */\n}\n\n.canvasNFT:hover {\n  width: 70%;\n}\n\n.canvasNFT:active {\n  width: 100%;\n  z-index: 500;\n  margin-bottom: 10rem;\n}\n\n.canvasNFT:active > .filaPixels > div {\n  border-bottom: 1px solid rgba(199, 171, 171, 0.6);\n  border-right: 1px solid rgba(199, 171, 171, 0.6);\n  margin: 0px;\n}\n\n.pixel {\n  transition: border-bottom 300ms 180ms, border-right 300ms 180ms;\n  background-color: rgb(216, 213, 213);\n  border: 1px solid transparent;\n  margin: -1px;\n}\n\n.pixelAux {\n  border: 0;\n  visibility: hidden;\n}\n\n.filaPixels {\n  display: flex;\n  flex-direction: row;\n  margin: 0px;\n}\n\n.tokenid {\n  color: #19422d;\n  font-weight: bold;\n  font-size: 1.6rem;\n  margin-top: 1rem;\n}\n\n.nombreNFT {\n  font-size: 1.3rem;\n  color: black;\n  margin-bottom: 1rem;\n}\n\n.swiper {\n  width: 100%;\n  height: 100%;\n}\n\n.swiper-slide {\n  text-align: center;\n  font-size: 18px;\n  color: black;\n  /* Center slide text vertically */\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.swiper-slide img {\n  display: block;\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n}\n\n.swiper-button-next {\n  color: white;\n  margin-right: 1.5rem;\n  padding-left: 120px;\n}\n\n.swiper-button-prev {\n  color: white;\n  margin-left: 1.5rem;\n  padding-right: 120px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
module.exports = "#container {\n  text-align: center;\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 50%;\n  transform: translateY(-50%);\n}\n\n#container strong {\n  font-size: 20px;\n  line-height: 26px;\n}\n\n#container p {\n  font-size: 16px;\n  line-height: 22px;\n  color: #8c8c8c;\n  margin: 0;\n}\n\n#container a {\n  text-decoration: none;\n}\n\n.columnaAlineacionAbajo {\n  display: flex;\n  flex-direction: row;\n  align-items: flex-end;\n}\n\n.capaDatos {\n  font-size: 0.9rem;\n  padding: 10px;\n  color: gainsboro;\n  font-family: \"Gill Sans\", \"Gill Sans MT\", Calibri, \"Trebuchet MS\", sans-serif;\n}\n\n.capaDatos div {\n  padding: 1px;\n}\n\nion-searchbar.customSearchbar {\n  --background: #19422d;\n  --color: #fff;\n  --placeholder-color: #fff;\n  --icon-color: #fff;\n  --clear-button-color: #fff;\n  --border-radius: 10px;\n  --box-shadow:0;\n  border-radius: 10px;\n  background-color: gainsboro;\n  padding: 2px;\n  border-width: 12px;\n}\n\n.metamask {\n  width: 60px;\n}\n\n.iconosFooter {\n  font-size: 1.8rem;\n  pointer-events: none;\n}\n\n#iconoEther {\n  height: 80%;\n}\n\n.capaFooter {\n  background-color: gainsboro;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n#capaInFooter {\n  display: flex;\n  flex-direction: row;\n  margin-right: 1rem;\n  height: 100%;\n  vertical-align: middle;\n  align-items: center;\n}\n\n.iconoDiv:hover #iconoEther {\n  filter: invert(99%);\n}\n\n.iconoDiv:hover {\n  background-color: #19422d;\n  color: white;\n}\n\n.iconoDiv {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  vertical-align: middle;\n  width: 3rem;\n  height: 3rem;\n  margin-top: 0.7rem;\n  margin-bottom: 0.7rem;\n  margin-right: 0.2rem;\n  background-color: gainsboro;\n  border-radius: 10px;\n  border: #19422d solid 3px;\n  cursor: pointer;\n  transition: all 0.3s ease-out;\n}\n\n.equis {\n  font-size: 0.8rem;\n  font-weight: bolder;\n  align-self: flex-end;\n  margin-bottom: 0.9rem;\n}\n\n.numeroEquis {\n  font-size: 1.1rem;\n  font-weight: bolder;\n  margin-right: 0.5rem;\n  margin-left: 0.1rem;\n  align-self: flex-end;\n  margin-bottom: 0.9rem;\n}\n\n#capaFiltro {\n  padding: 10px;\n  width: 100%;\n  position: absolute;\n  top: -10px;\n  left: 1px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";

/***/ }),

/***/ 54364:
/*!*****************************************************************************!*\
  !*** ./src/app/componentes/swiperkuai/swiperkuai.component.html?ngResource ***!
  \*****************************************************************************/
/***/ ((module) => {

module.exports = "<swiper #newSwiper \n[slidesPerView]=\"4\" \n[spaceBetween]=\"0\" \n[cssMode]=\"false\"\n[allowTouchMove]=\"false\"\n[navigation]=\"true\"\n[pagination]=\"false\"\n[centeredSlides]=\"true\"\n(slideChangeTransitionEnd)=\"cambiaSlide()\"\n(slideChangeTransitionStart)=\"cambiando()\"\n(update)=\"cambiaSlide()\"\n >\n</swiper>\n\n ";
...
module.exports = "\n<ion-header [translucent]=\"true\">\n  <ion-grid>\n      <ion-row>\n        <ion-col >\n          \n               <ion-grid>\n                <ion-row >\n                   <ion-col size=\"4\" >\n                    <img src=\"/assets/graficos/thewalllogo.png\" class=\"logo\" alt=\"logo\">\n                   </ion-col>\n                  \n                </ion-row>\n               </ion-grid>\n          \n        </ion-col>\n        <ion-col class=\"columnaAlineacionAbajo\">\n          <ion-content >\n            <div >\n                \n        </div>\n        </ion-content>\n        </ion-col>\n        <ion-col>\n\n          <ion-grid>\n            <ion-row>\n               <ion-col>\n                <div class=\"ContenWallet\">\n                  <div class=\"ContenWalletB\" *ngIf=\"!wallet.address\">\n                <img src=\"/assets/graficos/metamasklogo.png\" class=\"metamask\" alt=\"Metamask\">\n                  </div>\n                  <div class=\"ContenWalletC\" *ngIf=\"!wallet.address\">\n                    <div class=\"botonWallet\" (mousedown)=\"loginMetamask()\">Conectar Wallet</div>\n                  </div>\n                    <div id=\"WalletData\" *ngIf=\"wallet.address\">\n                      <div class=\"divWalletIN\">\n                        \n                        <div class=\"divWalletINiconOuter\">\n                          <div class=\"divWalletINicon\">\n                            <ion-icon class=\"iconW\" name=\"card\"></ion-icon>\n                          </div>\n                         </div>\n                          <div class=\"divWalletINaddress\">\n                            <ion-label>{{wallet.address | slice:0:3}}...{{wallet.address | slice:-4}}</ion-label>\n                            \n                          </div>\n                          <div class=\"divWalletMy\" (mousedown)=\"MyNFT()\" (mouseenter)=\"showMyToastMy('Mis NFTs')\" (mouseleave)=\"hideMyToast()\">\n                            <ion-icon class=\"iconMy\" name=\"briefcase-outline\"></ion-icon>\n                          </div>\n                          <div class=\"divWalletOUT\" (mousedown)=\"desconectar()\">\n                            <ion-icon class=\"iconOut\" name=\"exit-outline\"></ion-icon>\n                          </div>\n                          \n                      </div>\n                    </div>\n                </div>\n               </ion-col>\n            </ion-row>\n            <ion-row>\n              <ion-col>\n                <ion-searchbar  [debounce]=\"300\" animated=\"true\"  placeholder=\"Buscar\" class=\"customSearchbar\" (ionChange)=\"filtra($event)\" (search)=\"busca($event)\" (ionCancel)=\"cancelaBusqueda()\"  (ionBlur)=\"cancelaBusqueda()\" (ionClear)=\"cancelaBusqueda()\"  ></ion-searchbar>          \n              </ion-col>\n              </ion-row>\n              <ion-row>\n              <ion-col>\n                <div id=\"capaFiltro\">\n                <ion-list *ngIf=\"visibleFiltro\">\n                  <ion-item  *ngFor=\"let result of resultadosFiltro\">\n                    <ion-label>{{ result }}</ion-label>\n                  </ion-item>\n                </ion-list>\n               </div>\n              </ion-col>\n              </ion-row>\n        \n           </ion-grid>\n\n         \n        </ion-col>\n      </ion-row>\n  </ion-grid>\n \n</ion-header>\n\n<ion-content [fullscreen]=\"true\">\n  <app-swiperkuai (eventoCambiando)=\"cambiandoSlide()\" (eventoCambiaSlide)=\"cambiaSlide($event)\" [eventoCarga]=\"eventObservableNFTLoaded$.asObservable()\"></app-swiperkuai>\n</ion-content>\n\n<ion-footer>\n \n  <div class=\"capaFooter\">\n    <div id=\"capaInFooter\">\n      <div class=\"iconoDiv\" (mousedown)=\"iraMintear()\" (mouseenter)=\"showMyToast('¡Crea un nuevo NFT!')\" (mouseleave)=\"hideMyToast()\"><ion-icon name=\"brush-outline\"  class=\"iconosFooter\"></ion-icon></div>\n      <div class=\"iconoDiv\" (mouseenter)=\"showMyToast('¡Me gusta!')\" (mousedown)=\"meGusta()\" (mouseleave)=\"hideMyToast()\"><ion-icon name=\"heart-outline\" class=\"iconosFooter\"></ion-icon></div>\n      <div class=\"equis\">X</div><div class=\"numeroEquis\">{{TokenLikes}}</div>\n      <div class=\"iconoDiv\" (mouseenter)=\"showMyToast('Realiza una donación')\" (mousedown)=\"patrocinio()\"  (mouseleave)=\"hideMyToast()\"><img id=\"iconoEther\" src=\"assets/svg/ethereum.svg\"></div>\n      <div class=\"equis\">X</div><div class=\"numeroEquis\">{{TokenBalance}}</div>\n      <div *ngIf=\"BotonSMS\" class=\"iconoDiv\" id=\"botonSMS\" (mousedown)=\"tokenMensajes()\" (mouseenter)=\"showMyToast('Ver mensajes')\" (mouseleave)=\"hideMyToast()\"> <ion-icon name=\"chatbox-outline\" class=\"iconosFooter\"></ion-icon></div>\n      \n    </div>\n  </div>\n\n</ion-footer>";
